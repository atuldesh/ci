 ...
 <nav class="navbar navbar-expand-lg bg-light mt-0" style="visibility: visible;">
    ...
    <?php   if($role=='F' || $role=='A'){  ?>
          ...
          <li class="nav-item">
            <a class="nav-link" onclick="loadFeesEntry()">Fees Entry</a>
          </li> 
          <?php } ?>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" onclick="studLedger()" href="#">Student Ledger</a></li>
              <?php  if($role=='A'){ ?>
              <li><a class="dropdown-item" onclick="collectionReport()" href="#">Collection Report</a></li>
              <li><a class="dropdown-item" onclick="courseWise()" href="#">Course Wise Collection</a></li>
              <?php } ?>
